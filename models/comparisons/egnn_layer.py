...
NOTE: this implementation excludes the optional edge features a_{ij} from the message passing.
See the 'message' method (it only takes h_i, h_j, pos_i, and pos_j as inputs).
"""
...
class EGNNLayer(MessagePassing):
    ...
    """
    def __init__(self, emb_dim, activation="relu", norm="layer", aggr="add", disable_position_mlp: bool = False):
        """
        Args:
